...
class Layout {
  const Layout(this.mainAxis, this.secondaryAxis, this.reverse);
...
class VisibilityDetectorDemoPageState
  ...
  static const _layouts = [
    Layout(Axis.vertical, Axis.horizontal, false),
    Layout(Axis.vertical, Axis.horizontal, true),
    Layout(Axis.horizontal, Axis.vertical, false),
    Layout(Axis.horizontal, Axis.vertical, true),
  ];
...
class SliverDemoPageSecondaryAxis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: externalCellPadding),
